...
| Reports and moderation queue | `views/admin.ts` | `routes/moderation.ts` (9 routes) | `reports`, `audit_log` | Moderator or admin; every action audited | `moderation.test.ts`, `abuse.test.ts`, `authorization.test.ts` | `docs/MODERATION.md` |
